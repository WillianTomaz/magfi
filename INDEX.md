...
|---------|------|---------|--------------|
| **magfi-core** | 8000 | Asset/Currency management | ✅ Yes |
| **magfi-ingestor** | 8001 | News collection & sentiment | ❌ Optional |
| **magfi-predictor** | 8002 | ML market predictions | ❌ Optional |
